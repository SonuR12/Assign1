...
import { items as staticItems } from "@/lib/data"; // <-- import static items
...
export default function ItemDetailPage() {
  ...
  useEffect(() => {
    ...
    // Combine static and stored items
    const allItems = [...staticItems, ...storedItems];
    const foundItem = allItems.find((i) => i.id === slug);
      ...
      <div className="py-12 w-full max-w-6xl">
        <div className="lg:w-full px-2 gap-10 flex flex-col sm:flex-row  items-center">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest uppercase">{item.type}</h2>
